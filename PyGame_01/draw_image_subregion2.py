...
def main(): 
    ...
    while True:
        ...
        screen.fill((0, 0, 0))
        screen.blit(images[counter % 2 + 0], (50, 50))
        screen.blit(images[counter % 2 + 2], (100, 50))
        screen.blit(images[counter % 2 + 4], (150, 50))
        screen.blit(images[counter % 2 + 6], (200, 50))
        counter += 1

        screen.blit(images[8], (pos_x, 150))
